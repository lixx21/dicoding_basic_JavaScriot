...
const Authors =  books.filter((book)=> book.sales > 1000000)

const greatAuthors = Authors.map((author) => { return `${author.author} adalah penulis buku ${author.title} yang sangat hebat!`});
  /**
